    ...
    return (
        <section className={style.how}>
            <article>
                ...
                <p>Nuestros insumos son comprados directamente a los campesinos de nuestro país. Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, perspiciatis.</p>
                <Btn_Ordena />
            </article>
            <article>
                <div>
                    ...
                    <h4>Harina</h4>
                    <p>Ingrediente fresco traido del mercado mas cercano. Ingrediente fresco traido del mercado mas cercano</p>
                </div>
                <div>
